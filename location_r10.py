...
def save():
    ...
    kdx_region.columns = ['sum_p_A','sum_p',col_str]
    
    file_kdx_District = 'kdx_District_' + O_type + str1 + '.xls'
    kdx_District.columns = ['sum_p_A','sum_p',col_str]
    
    if supply != 'P/C' and supply != 'sum(D*f)':
        col_str_w = col_str + 'w'
        kdx_District[col_str_w] = kdx_District[col_str]*10000
        kdx_region[col_str_w] = kdx_region[col_str]*10000
